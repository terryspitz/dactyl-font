...
const TABS = [
  ...
  // Grow is now the default mode of the merged Generate tab; renders via a
  // WebGL canvas when WebGL2 is available, else the SVG fallback, both only
  // mounting once the growth field/SVG has arrived.

...
export default function SplineGrid() {
  ...
  return (
    <div style={{ padding: '20px', fontFamily: 'sans-serif' }}>
      ...
      <p style={{ marginBottom: '4px', fontSize: '13px', color: '#555', maxWidth: '700px' }}>
      ...
      <p style={{ marginBottom: '20px', fontSize: '12px', color: '#777' }}>
      ...
      {sections.map(({ isClosed, withTangent, label }) => (
        <div key={label} style={{ marginBottom: '40px' }}>
          <h3 style={{ marginBottom: '8px', color: '#222' }}>{label}</h3>

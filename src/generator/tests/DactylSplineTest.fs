...
type LineToCurveTests() =
    ...
    member this.LineToCurve_G2_Open_ShouldRenderValidCurve() =
        ...
        let spline = DactylSpline(ctrlPts, false)
        let svg = solve_and_print_spline spline
        let bezPts, _, _, _ = spline.solveAndRenderFull(max_iter, 1.0, 0.0, false, false, false)
                ...
                for it0 in 0 .. 3 do
                    for it1 in 0 .. 3 do
                        ...
                        try
                            ...
                            let bezPts, _, _, _ = spline.solveAndRenderFull(200, 1.0, 0.0, false, false, false)
    ...
    member this.Closed_G2_G2_LC_SmoothAtP0() =
        ...
        let spline = DactylSpline(ctrlPts, true)
        let bezPts, _, _, _ = spline.solveAndRenderFull(500, 1.0, 0.0, false, false, false)
